...
function renderTable() {
  ...
  for (let index = 0; index < produtosBebidas.length; index++) {
      ...
      row.innerHTML += `  <td>${produtosBebidas[index].id}</td>
                          ...
                          <td><button class="btn btn-warning" onclick="renderEditModal()">Editar</button></td>
                          <td><button class="btn btn-danger" onclick="deleteData(${produtosBebidas[index].id})">Excluir</button></td>
                          `
